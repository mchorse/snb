...
public class GuiActionsPanel extends GuiMorphPanel<AnimatedMorph, GuiAnimatedMorph>
{
    ...
    public void draw(GuiContext context)
    {
        ...
        this.font.drawStringWithShadow("Actions", this.configs.area.x, this.configs.area.y - 12, 0xffffff);

        if (this.fields.isVisible())
        {
            this.font.drawStringWithShadow("Action", this.action.area.x, this.action.area.y - 12, 0xffffff);
