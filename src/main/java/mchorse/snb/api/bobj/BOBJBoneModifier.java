 ...
 * Bone IK modifier
 *
 * IMPORTANT: that was work in progress at some point, I didn't manage
 * to replicate the way it worked in Blender, so I gave up. If you're
 * reading this, big RIP. You could try implementing it yourself, but
 * it's kind of hard... :[
 */
